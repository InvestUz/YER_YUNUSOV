        ...
        <div class="max-w-7xl mx-auto px-6 py-6">
            ...
            <div class="bg-white shadow-sm rounded mb-4 p-6">
                ...
                <div class="text-sm text-gray-600">
                    ...
                    <span class="ml-4">Сотилган нарх: <strong>{{ number_format($lot->sold_price, 0, '.', ' ') }}
                            сўм</strong></span>
                </div>
            </div>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded mb-4 p-4">
                        <p class="text-yellow-800">
                            ...
                            <a href="{{ route('contracts.create', ['lot_id' => $lot->id]) }}"
                                class="underline ml-2">Шартнома яратиш →</a>
                        </p>
                    </div>
                @endif
            @endif
                        ...
                        <table class="min-w-full text-xs border-collapse">
                            <thead>
                                ...
                                <tr class="bg-gray-100">
                                    ...
                                    <th colspan="3" class="px-2 py-2 border text-center">хисобот даврида (сўздиришув)
                                    </th>
                                    <th colspan="3" class="px-2 py-2 border text-center">иш ўрини соли</th>
                                    <th colspan="3" class="px-2 py-2 border text-center">хисобот саналари (усиб бўлиниш)
                                    </th>
                                    <th colspan="3" class="px-2 py-2 border text-center">иш ўрини соли</th>
