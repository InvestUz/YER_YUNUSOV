            ...
            <tr class="hover:bg-green-50 transition-colors">
                ...
                <td class="py-3 px-4">
                    <select name="lot_status" id="lot_status">
                        ...
                        <option value="Аукцион/Танлов якунланди">Аукцион/Танлов якунланди</option>
                        <option value="Ғолиб мол мулк қийматини тўлади">Ғолиб мол мулк қийматини тўлади</option>
                        <option value="Савдо/танлов натижаларини расмийлаштириш">Савдо/танлов натижаларини
                            расмийлаштириш</option>
                        <option value="Ғолиб шартнома имзолашга розилик билдирди">Ғолиб шартнома имзолашга розилик
                            билдирди</option>
                        <option value="Иштирокчи розилигини кутиш жараёнида">Иштирокчи розилигини кутиш жараёнида
                        </option>
                        <option value="Буюртмачи розилигини кутиш жараёнида">Буюртмачи розилигини кутиш жараёнида
                        </option>
                        <option value="Иштирокчи ва Буюртмачи келишуви ёки Суд қарорини кутиш жараёнида">Иштирокчи ва
                            Буюртмачи келишуви ёки Суд қарорини кутиш жараёнида</option>
                        <option value="Вактинча тухтатилди">Вактинча тухтатилди</option>
                        <option value="Низоли">Низоли</option>
                        <option value="Захирадаги -олибга таклиф">Захирадаги -олибга таклиф</option>
                        <option value="Лот якунланди">Лот якунланди</option>
                    </select>
                ...
                <tr class="bg-purple-50 hover:bg-purple-100 transition-colors border-t-2 border-purple-200">
                    ...
                    <td class="py-3 px-4">
                        <div class="text-purple-700 font-bold text-base">
                            {{ number_format($lot->contract->initial_paid_amount, 0, '.', ' ') }} UZS
                        </div>
