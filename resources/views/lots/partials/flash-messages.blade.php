...
@if (session('warning'))
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="bg-orange-50 border-l-4 border-orange-500 rounded-r-lg p-4 shadow-sm animate-slideDown"
            role="alert">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="font-semibold text-orange-900">Огоҳлантириш</p>
                        <p class="text-sm text-orange-800">{{ session('warning') }}</p>
                    </div>
                </div>
                <button onclick="this.parentElement.parentElement.parentElement.remove()"
