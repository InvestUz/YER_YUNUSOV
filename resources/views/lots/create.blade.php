    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-5xl mx-auto px-6">
            ...
            <form action="{{ route('lots.store') }}" method="POST" id="lotForm">
                            ...
                            <select name="tuman_id" id="tuman_select" required
                                ...
                                @foreach ($tumans as $tuman)
                                    <option value="{{ $tuman->id }}"
                                        {{ old('tuman_id') == $tuman->id ? 'selected' : '' }}>
                                        {{ $tuman->name_uz }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select name="master_plan_zone" id="master_plan_zone"
                                    ...
                                    <option value="Konservatsiya"
                                        {{ old('master_plan_zone') == 'Konservatsiya' ? 'selected' : '' }}>Konservatsiya
                                    </option>
                                    <option value="Rekonstruksiya"
                                        {{ old('master_plan_zone') == 'Rekonstruksiya' ? 'selected' : '' }}>Rekonstruksiya
                                    </option>
                                    <option value="Renovatsiya"
                                        {{ old('master_plan_zone') == 'Renovatsiya' ? 'selected' : '' }}>Renovatsiya
                                    </option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select name="yangi_uzbekiston" id="yangi_uzbekiston"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-blue-600 font-medium transition">
                                    <option value="0" {{ old('yangi_uzbekiston', '0') == '0' ? 'selected' : '' }}>Йўқ
                                    </option>
                                    <option value="1" {{ old('yangi_uzbekiston') == '1' ? 'selected' : '' }}>Ҳа
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="initial_price" id="initial_price"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-600 font-medium transition"
                                    value="{{ old('initial_price') }}" placeholder="267924294.00">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select name="winner_type" id="winner_type"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-600 font-medium transition">
                                    <option value="">-- Танланг --</option>
                                    <option value="G`olib" {{ old('winner_type') == 'G`olib' ? 'selected' : '' }}>G`olib
                                    </option>
                                    <option value="Salohiyatli g`olib"
                                        {{ old('winner_type') == 'Salohiyatli g`olib' ? 'selected' : '' }}>Salohiyatli
                                        g`olib</option>
                            ...
                            <div>
                                ...
                                <select name="huquqiy_subyekt" id="huquqiy_subyekt"
                                    ...
                                    <option value="Jismoniy shaxs"
                                        {{ old('huquqiy_subyekt') == 'Jismoniy shaxs' ? 'selected' : '' }}>Jismoniy shaxs
                                    </option>
                                    <option value="Yuridik shaxs"
                                        {{ old('huquqiy_subyekt') == 'Yuridik shaxs' ? 'selected' : '' }}>Yuridik shaxs
                                    </option>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="auction_type" id="auction_type"
                                    class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:border-green-600 font-medium transition">
                                    <option value="">-- Танланг --</option>
                                    <option value="ochiq" {{ old('auction_type') == 'ochiq' ? 'selected' : '' }}>Очиқ
                                    </option>
                                    <option value="yopiq" {{ old('auction_type') == 'yopiq' ? 'selected' : '' }}>Ёпиқ
                                    </option>
                                </select>
                            </div>
                        </div>
                ...
                {{-- FINAL SUBMIT --}}
                <div
                    class="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-300 shadow-lg rounded-lg overflow-hidden">
                    <div class="p-6">
