    ...
    <div class="max-w-7xl mx-auto px-6 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="flex items-center justify-between px-4 py-3 bg-gray-50 border-t border-gray-300 text-sm text-gray-600">
                        <div class="flex items-center gap-6">
                            ...
                            <div class="flex items-center gap-1 group relative cursor-pointer" onclick="showMessages()">
                                ...
                                <span class="inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-600 rounded-full">{{ $unreadMessagesCount }}</span>
                                @endif
                            </div>
                ...
                <div class="bg-white border border-gray-300 shadow-sm">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-300">
                        <h2 class="text-base font-bold text-gray-900">Тўлиқ маълумотлар</h2>
                    </div>
                    <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Уникал рақами (Кадастр)</td>
                                    <td class="py-3 px-4 text-gray-900 font-mono">{{ $lot->unique_number ?? '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        ...
                                        <span class="inline-block px-2 py-1 bg-blue-100 text-blue-800 border border-blue-300 text-xs font-medium">Ҳа</span>
                                        @else
                                        <span class="inline-block px-2 py-1 bg-gray-100 text-gray-800 border border-gray-300 text-xs font-medium">Йўқ</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Ер майдони</td>
                                    <td class="py-3 px-4 text-gray-900 font-semibold">{{ $lot->land_area ? number_format($lot->land_area, 2) . ' га' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Қурилишга рухсат берилган объект тури</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->object_type ?? '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Объект тури (RU)</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->object_type_ru ?? '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Қурилиш умумий майдони (кв.м)</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->construction_area ? number_format($lot->construction_area, 2) . ' м²' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Киритиладиган инвестиция (АҚШ долл)</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->investment_amount ? '$' . number_format($lot->investment_amount, 2) : '-' }}</td>
                                </tr>
                                <tr class="bg-blue-50 hover:bg-blue-100">
                                    <td class="py-3 px-4 text-gray-700 font-bold">Бошланғич нархи</td>
                                    <td class="py-3 px-4 text-blue-700 font-bold text-base">{{ $lot->initial_price ? number_format($lot->initial_price, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Аукцион санаси</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->auction_date ? $lot->auction_date->format('d.m.Y') : '-' }}</td>
                                </tr>
                                <tr class="bg-green-50 hover:bg-green-100">
                                    <td class="py-3 px-4 text-gray-700 font-bold">Сотилган нархи</td>
                                    <td class="py-3 px-4 text-green-700 font-bold text-base">{{ $lot->sold_price ? number_format($lot->sold_price, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4 text-gray-900">
                                        ...
                                        <span class="inline-block px-2 py-1 bg-blue-100 text-blue-800 border border-blue-300 text-xs font-medium">Муддатли</span>
                                        @else
                                        <span class="inline-block px-2 py-1 bg-gray-100 text-gray-800 border border-gray-300 text-xs font-medium">Муддатли эмас</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4">
                                        ...
                                        <div>
                                            <span class="inline-block px-2 py-1 bg-green-100 text-green-800 border border-green-300 text-xs font-medium mb-2">Тузилган</span>
                                            @if($lot->contract_date)
                                            <div class="text-sm text-gray-700">Сана: {{ $lot->contract_date->format('d.m.Y') }}</div>
                                            @endif
                                        ...
                                        @else
                                        <span class="inline-block px-2 py-1 bg-gray-100 text-gray-800 border border-gray-300 text-xs font-medium">Тузилмаган</span>
                                        @endif
                                    </td>
                                </tr>
                                <tr class="bg-yellow-50 hover:bg-yellow-100">
                                    <td class="py-3 px-4 text-gray-700 font-bold">Ғолиб аукционга тўлаган сумма</td>
                                    <td class="py-3 px-4 text-gray-900 font-semibold">{{ $lot->paid_amount ? number_format($lot->paid_amount, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Буюртмачига ўтказилган сумма</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->transferred_amount ? number_format($lot->transferred_amount, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Чегирма</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->discount ? number_format($lot->discount, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Аукцион ҳаражати (1%)</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->auction_fee ? number_format($lot->auction_fee, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Тушадиган маблағ</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->incoming_amount ? number_format($lot->incoming_amount, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="bg-purple-50 hover:bg-purple-100">
                                    <td class="py-3 px-4 text-gray-700 font-bold">Давактивга тушган маблағ</td>
                                    <td class="py-3 px-4 text-purple-700 font-bold">{{ $lot->davaktiv_amount ? number_format($lot->davaktiv_amount, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                                <tr class="hover:bg-gray-50">
                                    <td class="py-3 px-4 text-gray-600 font-medium">Ерни аукционга чиқариш ва аукцион харажатлари</td>
                                    <td class="py-3 px-4 text-gray-900">{{ $lot->auction_expenses ? number_format($lot->auction_expenses, 0, '.', ' ') . ' UZS' : '-' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="p-4 bg-blue-50 border border-blue-300">
                                ...
                                <p class="text-lg font-bold text-blue-700">{{ number_format($distributionStats['local_budget'], 0, '.', ' ') }}</p>
                            ...
                            <div class="p-4 bg-green-50 border border-green-300">
                                ...
                                <p class="text-lg font-bold text-green-700">{{ number_format($distributionStats['development_fund'], 0, '.', ' ') }}</p>
                                <p class="text-xs text-gray-500 mt-1">UZS</p>
                            </div>
                            @endif
                            ...
                            <div class="p-4 bg-purple-50 border border-purple-300">
                                ...
                                <p class="text-lg font-bold text-purple-700">{{ number_format($distributionStats['new_uzbekistan'], 0, '.', ' ') }}</p>
                                <p class="text-xs text-gray-500 mt-1">UZS</p>
                            </div>
                            @endif
                            ...
                            <div class="p-4 bg-orange-50 border border-orange-300">
                                ...
                                <p class="text-lg font-bold text-orange-700">{{ number_format($distributionStats['district_authority'], 0, '.', ' ') }}</p>
                                <p class="text-xs text-gray-500 mt-1">UZS</p>
                            </div>
                            @endif
                        </div>
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="py-3 px-4 text-right font-medium text-gray-900">{{ number_format($schedule->planned_amount, 0, '.', ' ') }}</td>
                                    <td class="py-3 px-4 text-right font-medium {{ $schedule->actual_amount > 0 ? 'text-green-600' : 'text-gray-400' }}">{{ number_format($schedule->actual_amount, 0, '.', ' ') }}</td>
                                    <td class="py-3 px-4 text-center">
                                        @if($schedule->actual_amount >= $schedule->planned_amount)
                                        <span class="inline-block px-3 py-1 bg-green-100 text-green-800 border border-green-300 text-xs font-medium">Тўланган</span>
                                        @elseif($schedule->payment_date < now())
                                        <span class="inline-block px-3 py-1 bg-red-100 text-red-800 border border-red-300 text-xs font-medium">Муддати ўтган</span>
                                        @else
                                        <span class="inline-block px-3 py-1 bg-yellow-100 text-yellow-800 border border-yellow-300 text-xs font-medium">Кутилмоқда</span>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="space-y-6">
                ...
                {{-- Financial Metrics --}}
                @if(isset($financialMetrics) && is_array($financialMetrics) && (($financialMetrics['price_increase'] ?? 0) > 0 || $lot->investment_amount > 0))
                <div class="bg-white border border-gray-300 shadow-sm">
                    <div class="px-6 py-4 bg-gray-50 border-b border-gray-300">
                        ...
                        <table class="w-full text-sm">
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="py-2 text-gray-900 font-medium text-right">{{ number_format($financialMetrics['price_per_hectare'], 0, '.', ' ') }} UZS</td>
                                </tr>
                                @endif
                                @if(($financialMetrics['price_increase'] ?? 0) > 0)
                                <tr>
                                    <td class="py-2 text-gray-600">Нарх ўсиши:</td>
                                    <td class="py-2 text-green-600 font-medium text-right">+{{ number_format($financialMetrics['price_increase_percent'] ?? 0, 1) }}%</td>
                                </tr>
                                <tr>
                                    <td class="py-2 text-gray-600">Фойда:</td>
                                    <td class="py-2 text-green-600 font-medium text-right">{{ number_format($financialMetrics['price_increase'], 0, '.', ' ') }} UZS</td>
                                </tr>
                                @endif
                                @if($lot->investment_amount > 0)
                                <tr>
                                    <td class="py-2 text-gray-600">Инвестиция:</td>
                                    <td class="py-2 text-gray-900 font-medium text-right">{{ number_format($lot->investment_amount, 0, '.', ' ') }} UZS</td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
                    ...
                    <div class="p-4 space-y-2">
                        ...
                        <a href="{{ route('analytics.lot.messages', $lot) }}"
                           class="block w-full text-center px-4 py-2 bg-white hover:bg-gray-50 text-gray-900 border border-gray-300 transition text-sm font-medium">
                            ...
                            Хабарлар
                            @if(isset($unreadMessagesCount) && $unreadMessagesCount > 0)
                            <span class="inline-flex items-center justify-center w-5 h-5 text-xs font-bold text-white bg-red-600 rounded-full ml-2">{{ $unreadMessagesCount }}</span>
                            @endif
                        </a>
                    </div>
                </div>
